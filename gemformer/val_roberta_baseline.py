...
parser.add_argument("--experiment_dir", type=str, default='../roberta_baseline_hotpotqa')
parser.add_argument("--val_dataset_path", type=str, default='../hotpotqa_preprocessed_train_examples_512_multitask_stride20_one_doc_batched_without_zero_answer_pos')
parser.add_argument("--raw_dataset_validation_path", type=str, default='../hotpotqa_val_examples_with_special_seps.pkl')
parser.add_argument("--get_top_2_sp_para", type=bool, default=True)


def main(args):
    train_script = 'train_roberta_baseline.py'
    ...
    raw_dataset_validation = torch.load(args.raw_dataset_validation_path)
        ...
        for batch in tqdm(val_loader):
            with torch.no_grad():
                outputs = model(input_ids=batch['input_ids'][0],
                                ...
                                paragraph_labels=batch['supp_title_labels'][0],
