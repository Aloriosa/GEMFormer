...
from utils import add_qa_evidence_tokens

parser = argparse.ArgumentParser(description="train")
parser.add_argument("--output_dir", type=str, default='../roberta_baseline_hotpotqa')
parser.add_argument("--tokenizer_name", type=str, default='roberta-base')
parser.add_argument("--question_type_num_labels", type=int, default=3)
parser.add_argument("--question_type_loss_weight", type=float, default=10.)
...
parser.add_argument("--tokens_to_add", nargs="*", type=str, default=False)
...
def main(args):
    ...
    model = RobertaGEMFormer.from_pretrained(
        ...
        ques_type_loss_weight=args.question_type_loss_weight, 
        ...
        for batch in train_loader:
            with accelerator.accumulate(model):
                outputs = model(
                    ...
                    #ques type values are the same for all doc chunks
